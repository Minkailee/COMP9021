...
R = turtle.numinput('Fixed circle',
                    'Radius R between {} and {}: '.format(min_R, max_R), minval = min_R, maxval = max_R)
R = round(R)
...
d = turtle.numinput('Point', 'Distance d to centre of rolling circle '
                    'between {} and {}: '.format(min_d, max_d), minval = min_d, maxval = max_d)
d = round(d)
period = r // gcd(r, R)
turtle.title('{} for R = {}, r = {}, d = {} -- Period = {}'.format(trochoid, R, r, d, period))
